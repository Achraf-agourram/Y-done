                ...
                <div class="space-y-6">
                    ...
                    <div>
                        <div class="flex justify-between items-center ml-1">
                            ...
                            @if (Route::has('password.request'))
                                <a class="text-xs text-orange-600 hover:underline font-medium" href="{{ route('password.request') }}">
                                    {{ __('Forgot password?') }}
                                </a>
                            @endif
                        </div>
                    ...
                    <div class="block px-1">
                        <label for="remember_me" class="inline-flex items-center cursor-pointer">
                            <input id="remember_me" type="checkbox" class="rounded-md border-orange-200 text-orange-600 shadow-sm focus:ring-orange-500" name="remember">
                            <span class="ms-2 text-sm text-amber-900 font-medium">{{ __('Keep me signed in') }}</span>
                        </label>
                    </div>
                </div>
